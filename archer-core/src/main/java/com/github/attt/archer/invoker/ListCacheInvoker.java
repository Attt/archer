 ...
 * @since 1.0
 */
public class ListCacheInvoker<V> extends AbstractInvoker<ListCacheConfig<V>, Collection<V>> implements ListComponent {

    private final static Logger logger = LoggerFactory.getLogger(ListCacheInvoker.class);

    @Override
    public Collection<V> get(InvocationContext context, ListCacheConfig<V> cacheOperation) {
    ...
    @Override
    public Map<InvocationContext, Collection<V>> getAll(List<InvocationContext> contextList, ListCacheConfig<V> cacheOperation) {
    ...
    @Override
    public void put(InvocationContext context, Collection<V> values, ListCacheConfig<V> cacheOperation) {
        ListCacheMetadata metadata = cacheOperation.getMetadata();
    ...
    @Override
    public void putAll(Map<InvocationContext, Collection<V>> contextValueMap, ListCacheConfig<V> cacheOperation) {
        // may be more elegant? not to use looping
